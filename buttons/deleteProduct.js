        ...
        try {
            ...
            if (products.length === 0) {
                return interaction.reply({
                    embeds: [{
                        ...
                        description: 'لا توجد منتجات لحذفها.',
                    }],
                    flags: 64
                });
            }
            ...
            const selectMenu = new ActionRowBuilder().addComponents(
                new StringSelectMenuBuilder()
                    ...
                    .setPlaceholder('اختر المنتج المراد حذفه')
            ...
            console.log(`📦 فتح قائمة حذف المنتج بواسطة ${interaction.user.tag}`);

        } catch (error) {
            console.error('خطأ في زر حذف منتج:', error);
